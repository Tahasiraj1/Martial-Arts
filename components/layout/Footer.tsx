  ...
  return (
    <footer className="bg-[#0e0f0f] text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="text-6xl sm:text-7xl md:text-8xl font-bold text-center mb-12 text-gray-300 opacity-20">
            YOUR BRAND
        </div>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/privacypolicy" className="hover:text-gray-400 transition-colors">Privacy Policy</Link></li>
              <li><Link href="/terms&conditions" className="hover:text-gray-400 transition-colors">Terms & Conditions</Link></li>
              <li><Link href="/shipping-policy" className="hover:text-gray-400 transition-colors">Shipping Policy</Link></li>
              <li><Link href="/return-policy" className="hover:text-gray-400 transition-colors">Return Policy</Link></li>
            </ul>
          </div>
